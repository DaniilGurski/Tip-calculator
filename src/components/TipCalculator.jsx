        ...
        <div className="tip-calculator__input-part">
          ...
          <fieldset>
            ...
            <ul className="tip-calculator__tip-percentages" role="listbox">
              <li role="option"> <TipPercentage percentage={5}  dispatch={dispatch} /> </li>
              <li role="option"> <TipPercentage percentage={10} dispatch={dispatch} /> </li>
              <li role="option"> <TipPercentage percentage={15} dispatch={dispatch} /> </li>
              <li role="option"> <TipPercentage percentage={25} dispatch={dispatch} /> </li>
              <li role="option"> <TipPercentage percentage={50} dispatch={dispatch} /> </li>
